...
var huisarts16 = 0; var huisarts17 = 0; var huisarts18 = 0; var huisarts19 = 0; var huisarts20 = 0; var huisarts21 = 0; var huisarts22 = 0; var huisarts23 = 0;
...
var commercieel15 = 0; var commercieel16 = 0; var commercieel17 = 0; var commercieel18 = 0; var commercieel19 = 0; var commercieel20 = 0; commercieel21 = 0; var commercieel22 = 0; var commercieel23 = 0;
...
$('input[type="checkbox"]').on('change', function() {
  ...
  if($('#v4a2').is(':checked')){huisarts4=1; commercieel4=1;} else if($('#v4a1').not(':checked')){huisarts4=0; commercieel4=0;}
  ...
  if($('#v11a2').is(':checked')){huisarts11=1; commercieel11=1;} else if($('#v11a2').not(':checked')){huisarts11=0;commercieel11=0;}
  if($('#v11a3').is(':checked')){huisarts11=1; commercieel11=1;} else if($('#v11a3').not(':checked')){huisarts11=0;commercieel11=0;}
  if($('#v11a4').is(':checked')){commercieel11=1} else if($('#v11a4').not(':checked')){commercieel11=0;}
  if($('#v11a5').is(':checked')){huisarts11=1} else if($('#v11a5').not(':checked')){huisarts11=0;}
  ...
  if($('#v12a2').is(':checked')){huisarts12=1;commercieel12=1;} else if($('#v12a2').not(':checked')){huisarts12=0;commercieel12=0;}
  if($('#v12a3').is(':checked')){huisarts12=1;} else if($('#v12a3').not(':checked')){huisarts12=0;}
  ...
  if($('#v14a3').is(':checked')){huisarts14=1;commercieel14=1;} else if($('#v14a3').not(':checked')){huisarts14=0;commercieel14=0;}
  ...
  if($('#v18a3').is(':checked')){huisarts18=1;} else if($('#v18a3').not(':checked')){huisarts18=0;}
  if($('#v18a4').is(':checked')){huisarts18=1;} else if($('#v18a4').not(':checked')){huisarts18=0;}
  if($('#v18a5').is(':checked')){geentest18=1;} else if($('#v18a5').not(':checked')){geentest18=0;}

  if($('#v19a1').is(':checked')){huisarts19=1;commercieel19=1;} else if($('#v19a1').not(':checked')){huisarts19=0;commercieel19=0;}
  if($('#v19a2').is(':checked')){huisarts19=1;commercieel19=1;} else if($('#v19a2').not(':checked')){huisarts19=0;commercieel19=0;}
  if($('#v19a3').is(':checked')){huisarts19=1;commercieel19=1;} else if($('#v19a3').not(':checked')){huisarts19=0;commercieel19=0;}
  if($('#v19a4').is(':checked')){huisarts19=1;commercieel19=1;} else if($('#v19a4').not(':checked')){huisarts19=0;commercieel19=0;}
  if($('#v19a5').is(':checked')){huisarts19=1;commercieel19=1;} else if($('#v19a5').not(':checked')){huisarts19=0;commercieel19=0;}
  if($('#v19a6').is(':checked')){geentest19=1;} else if($('#v19a6').not(':checked')){geentest19=0;}

  if($('#v20a1').is(':checked')){huisarts20=1;commercieel20=1;} else if($('#v20a1').not(':checked')){huisarts20=0;commercieel20=0;}
  if($('#v20a2').is(':checked')){huisarts20=1;commercieel20=1;} else if($('#v20a2').not(':checked')){huisarts20=0;commercieel20=0;}
  if($('#v20a3').is(':checked')){huisarts20=1;commercieel20=1;} else if($('#v20a3').not(':checked')){huisarts20=0;commercieel20=0;}
  if($('#v20a4').is(':checked')){huisarts20=1;commercieel20=1;} else if($('#v20a4').not(':checked')){huisarts20=0;commercieel20=0;}
  if($('#v20a5').is(':checked')){huisarts20=1;commercieel20=1;} else if($('#v20a5').not(':checked')){huisarts20=0;commercieel20=0;}
  if($('#v20a6').is(':checked')){geentest20=1;} else if($('#v20a6').not(':checked')){geentest19=0;}

  if($('#v21a1').is(':checked')){commercieel21=1;} else if($('#v21a1').not(':checked')){commercieel21=0;}
  if($('#v21a2').is(':checked')){commercieel21=1;} else if($('#v21a2').not(':checked')){commercieel21=0;}
  ...
  if($('#v22a2').is(':checked')){huisarts22=1;commercieel22=1;} else if($('#v22a2').not(':checked')){huisarts22=0;commercieel22=0;}
  if($('#v22a3').is(':checked')){geentest22=1;} else if($('#v22a2').not(':checked')){geentest23=0;}

  if($('#v23a1').is(':checked')){huisarts23=1;commercieel23=1;} else if($('#v23a1').not(':checked')){huisarts23=0;commercieel23=0;}
  if($('#v23a2').is(':checked')){huisarts23=1;commercieel23=1;} else if($('#v23a2').not(':checked')){huisarts23=0;commercieel23=0;}
  if($('#v23a3').is(':checked')){geentest23=1;} else if($('#v23a2').not(':checked')){geentest23=0;}


  var antwoord1 = huisarts1 + huisarts2 + huisarts3 + huisarts4 + huisarts5 + huisarts6 + huisarts7 + huisarts8 + huisarts9 + huisarts10 + huisarts11 + huisarts12 + huisarts13 + huisarts14 + huisarts15 + huisarts16 + huisarts17 + huisarts18 + huisarts19 + huisarts20 + huisarts21 + huisarts22 + huisarts23;

  console.log('antwoord1',antwoord1);


  var antwoord2 = commercieel1 + commercieel2 + commercieel3 + commercieel4 + commercieel5 + commercieel6 + commercieel7 + commercieel8 + commercieel9 + commercieel10 + commercieel11 + commercieel12 + commercieel13 + commercieel14 + commercieel15 + commercieel16 + commercieel17 + commercieel18 + commercieel19 + commercieel20 + commercieel21 + commercieel22 + commercieel23;

  console.log('antwoord2',antwoord2);

  var antwoord3 = geentest1 + geentest2 + geentest3 + geentest4 + geentest5 + geentest6 + geentest7 + geentest8 + geentest9 + geentest10 + geentest11 + geentest12 + geentest13 + commercieel14 + geentest15 + geentest16 + geentest17 + geentest18 + geentest19 + geentest20 + geentest21 + geentest22 + geentest23;
